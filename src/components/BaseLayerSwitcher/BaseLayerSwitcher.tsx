...
export interface BaseLayerSwitcherTitles {
  button?: string;
  closeSwitcher?: string;
  openSwitcher?: string;
}

export interface BaseLayerSwitcherProps {
  /**
   ...
   */
  onCloseButtonClick?: (evt: React.KeyboardEvent | React.MouseEvent) => void;
  /**
   ...
   * Button titles.
   */
  titles?: BaseLayerSwitcherTitles;
}
...
interface CloseButtonProps {
  ...
  onClick: (evt?: React.KeyboardEvent | React.MouseEvent) => void;
  tabIndex: number;
  title: string;
}

function CloseButton({ children, onClick, tabIndex, title }: CloseButtonProps) {
  return (
    <div
      aria-label={title}
...
const getDefaultLabel = (layer: Layer) => {
