...
const wmtsResolutions = [156543.033928, 78271.516964, 39135.758482,
  19567.879241, 9783.9396205, 4891.96981025, 2445.98490513, 1222.99245256,
  ...
  constructor(options) {
    ...
    const olLayer = new TileLayer({
      source: new WMTSSource({
        ...
        tileGrid: tileGrid || new WMTSTilegrid({
